...
<div class="container" id="adminHome">
	<br><br><br>
	  <a class="d-grid gap-2" href="admin/contact" id="card">
	  ...
	  <a class="d-grid gap-2" href="admin/showPendaftar" id="card">
	  	<button class="btn" id="background" type="button">Pendaftar</button>
	  </a>			
</div>
</main>
